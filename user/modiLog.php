...
<body>
<h3 class="subtitle">Assignment Management >> Edit Assignment</h3>
    ...
    <span>Date：</span><input name="logdate" required type="date" style="width:180px" value="<?php echo $row->logdate ?>"><br>
    <input name="addtime"required  type="text" style="display:none;" value="<?php echo $row->addtime ?>">
    <span>Course Name：</span><input name="reason"required  type="text" class="boxwidth" value="<?php echo $row->reason ?>">
    <br>
